{% macro init_s3_sources() -%}
    ...
    {% set sources = [
        ...
        ENGINE = S3(\'https://storage.yandexcloud.net/ch-data-course/customer.tbl\', \'NOSIGN\', \'CustomSeparated\')
        SETTINGS
        ...
        ENGINE = S3(\'https://storage.yandexcloud.net/ch-data-course/orders.tbl\', \'NOSIGN\',\'CustomSeparated\')
        SETTINGS
            format_custom_field_delimiter=\'|\'
            ,format_custom_escaping_rule=\'CSV\'
            ,format_custom_row_after_delimiter=\'|\n\'                
        ...
        ENGINE = S3(\'https://storage.yandexcloud.net/ch-data-course/lineitem.tbl\', \'NOSIGN\',\'CustomSeparated\')
        SETTINGS
            format_custom_field_delimiter=\'|\'
            ,format_custom_escaping_rule=\'CSV\'
            ,format_custom_row_after_delimiter=\'|\n\'                
        ...
        ENGINE = S3(\'https://storage.yandexcloud.net/ch-data-course/part.tbl\', \'NOSIGN\',\'CustomSeparated\')
        SETTINGS
            format_custom_field_delimiter=\'|\'
            ,format_custom_escaping_rule=\'CSV\'
            ,format_custom_row_after_delimiter=\'|\n\'                
        ...
        ENGINE = S3(\'https://storage.yandexcloud.net/ch-data-course/supplier.tbl\', \'NOSIGN\',\'CustomSeparated\')
        SETTINGS
            format_custom_field_delimiter=\'|\'
            ,format_custom_escaping_rule=\'CSV\'
            ,format_custom_row_after_delimiter=\'|\n\'                
